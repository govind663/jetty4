            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-body add-post">
                        <form method="POST" action="{{ route('associates.update', $associate->id) }}" class="form-horizontal" enctype="multipart/form-data">
                            @csrf
                            @method('PATCH')

                            <input type="text" id="id" name="id" hidden  value="{{ $associate->id }}">
                            ...
                            <div class="pd-20 card-box mb-30">
                                ...
                                <div class="form-group row mt-3">
                                    ...
                                    <div class="col-sm-10 col-md-10">
                                        <input type="text" name="title" id="title" class="form-control @error('title') is-invalid @enderror" value="{{ $associate->title }}" placeholder="Enter Title">
                                        @error('title')
                                ...
                                <div class="form-group row mt-3">
                                    ...
                                    <div class="col-sm-10 col-md-10">
                                        <textarea name="description" id="description" class="form-control @error('description') is-invalid @enderror" placeholder="Enter Description" value="{{ $associate->description }}">{{ $associate->description }}</textarea>
                                        @error('description')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                ...
                                <div class="form-group row mt-3 p-3">
                                    ...
                                    <table class="table table-bordered p-3" id="dynamicAmenitiesTable">
                                        ...
                                        <tbody>
                                            @php
                                                $uploadedImages = json_decode($associate->image ?? '[]', true);
                                            @endphp
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="image-preview">
                                                                <img src="{{ asset('/j4c_Group/associates/image/'.$image) }}" alt="Uploaded Image" width="100" height="100" class="img-thumbnail">
                                ...
                                <div class="form-group row mt-4">
                                    ...
                                    <div class="col-md-9" style="display: flex; justify-content: flex-end;">
                                        <a href="{{ route('associates.index') }}" class="btn btn-danger"><b>Cancel</b></a>&nbsp;&nbsp;
