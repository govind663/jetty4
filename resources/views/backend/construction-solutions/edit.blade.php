...
@section('title')
J4C Group | Edit Construction Solutions
@endsection
...
<div class="page-body">
    <div class="container-fluid">
        <div class="page-title">
            <div class="row">
                <div class="col-6">
                    <h4>Edit Construction Solutions</h4>
                </div>
                <div class="col-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Edit Construction Solutions</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-body add-post">
                        <form method="POST" action="{{ route('construction-solutions.update', $constructionSolutions->id) }}" id="update_construction_solutions_form') }}" class="form-horizontal" enctype="multipart/form-data">
                            @csrf
                            @method('PATCH')

                            <input type="text" id="id" name="id" hidden  value="{{ $constructionSolutions->id }}">
                            ...
                            <div class="pd-20 card-box mb-30">
                                ...
                                <div class="form-group row mt-3">
                                    ...
                                    <div class="col-sm-4 col-md-4">
                                        <input type="text" name="title" id="title" class="form-control @error('title') is-invalid @enderror" value="{{ $constructionSolutions->title }}" placeholder="Enter Title">
                                        @error('title')
                                    ...
                                    <div class="col-sm-4 col-md-4">
                                        <input type="file" onchange="agentPreviewFile()" accept=".png, .jpg, .jpeg, .webp" name="image" id="image" class="form-control @error('image') is-invalid @enderror" value="{{ $constructionSolutions->image }}" placeholder="Upload Image.">
                                        ...
                                        @if(!empty($constructionSolutions->image))
                                            <img src="{{ asset('/j4c_Group/construction-solutions/image/' . $constructionSolutions->image) }}" alt="Banner Image" style="width: auto; height: 200px;">
                                        @endif
                                    </div>
                                </div>
                                        ...
                                        <tbody>
                                            @if(!empty($solutions))
                                                @foreach($solutions as $index => $solution)
                                                    <tr>
                                                        <td>
                                                            <input type="text" name="solution_name[]" value="{{ $solution }}" class="form-control @error("solution_name.$index") is-invalid @enderror" placeholder="Enter Solution Name">
                                                        ...
                                                        <td>
                                                            <textarea name="solution_description[]" class="form-control @error("solution_description.$index") is-invalid @enderror" placeholder="Enter Solution Description">{{ $descriptions[$index] ?? '' }}</textarea>
...
<script>
    $(document).ready(function () {
        let rowId = {{ count($solutions ?? []) }}; // Start from existing count
