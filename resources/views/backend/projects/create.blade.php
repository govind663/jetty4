                                    ...
                                    <div class="col-sm-4 col-md-4">
                                        <select name="project_type_id" id="project_type_id" class="form-control myselect @error('project_type_id') is-invalid @enderror" value="{{ old('project_type_id') }}">
                                            ...
                                            @foreach ($project_types as $project_type)
                                                <option value="{{ $project_type->id }}" {{ old('project_type_id') == $project_type->id ? 'selected' : '' }}>{{ $project_type->project_type }}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="col-sm-4 col-md-4">
                                        <select name="project_status" id="project_status" class="myselect form-control @error('project_status') is-invalid @enderror">
                                            ...
                                            <optgroup label="Status">
                                                <option value="1" {{ old('project_status') == '1' ? 'selected' : '' }}>Completed Projects</option>
                                                <option value="2" {{ old('project_status') == '2' ? 'selected' : '' }}>Ongoing Projects</option>
                                                <option value="3" {{ old('project_status') == '3' ? 'selected' : '' }}>Upcoming Projects</option>
                                            </optgroup>
                                        </select>
