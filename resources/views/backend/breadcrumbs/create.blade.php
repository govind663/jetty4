                ...
                <div class="col-sm-12">
                    <div class="card">
                        <div class="card-body add-post">
                            <form method="POST" action="{{ route('breadcrumb.store') }}" class="form-horizontal" enctype="multipart/form-data">
                                @csrf
                                    ...
                                    <div class="form-group row mt-3">
                                        ...
                                        <div class="col-sm-4 col-md-4">
                                            <select name="page_type" id="page_type" class="myselect form-control @error('page_type') is-invalid @enderror">
                                                ...
                                                <optgroup label="Type">
                                                    <option value="1" {{ old('page_type') == '1' ? 'selected' : '' }}>About J4C</option>
                                                    <option value="2" {{ old('page_type') == '2' ? 'selected' : '' }}>Mission & Vision</option>
                                                    <option value="3" {{ old('page_type') == '3' ? 'selected' : '' }}>Awards & Certifications</option>
                                                    <option value="4" {{ old('page_type') == '4' ? 'selected' : '' }}>Our USP</option>
                                                    <option value="5" {{ old('page_type') == '5' ? 'selected' : '' }}>Sustainability</option>
                                                    <option value="6" {{ old('page_type') == '6' ? 'selected' : '' }}>Careers</option>
                                                    <option value="7" {{ old('page_type') == '7' ? 'selected' : '' }}>Media Events</option>
                                                    <option value="8" {{ old('page_type') == '8' ? 'selected' : '' }}>Contact Us</option>
                                                </optgroup>
                                            </select>
                                            @error('page_type')
                                                <span class="invalid-feedback" role="alert">
