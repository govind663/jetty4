            ...
            <div class="row">
                ...
                <div class="col-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Add Carrier Details</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-body add-post">
                        <form method="POST" action="{{ route('carrier-details.store') }}" class="form-horizontal" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="pd-20 card-box mb-30">
                                ...
                                <div class="form-group row mt-3">
                                    ...
                                    <div class="col-sm-10 col-md-10">
                                        <textarea name="other_description" id="other_description" class="form-control @error('other_description') is-invalid @enderror" placeholder="Enter Other Description" value="{{ old('other_description') }}">{{ old('other_description') }}</textarea>
