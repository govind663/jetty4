...
@section('title')
J4C Group | Add Safety Commitment
@endsection
            ...
            <div class="row">
                ...
                <div class="col-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Add Safety Commitment</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-body add-post">
                        <form method="POST" action="{{ route('safety-commitment.store') }}" class="form-horizontal" enctype="multipart/form-data">
                            @csrf
