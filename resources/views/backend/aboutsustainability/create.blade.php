...
@section('title')
J4C Group | Add About Sustainability
@endsection
...
<div class="page-body">
    <div class="container-fluid">
        <div class="page-title">
            <div class="row">
                <div class="col-6">
                    <h4>Add About Sustainability</h4>
                </div>
                <div class="col-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Add About Sustainability</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-body add-post">
                        <form method="POST" action="{{ route('about-sustainability.store') }}" class="form-horizontal" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="pd-20 card-box mb-30">
                                ...
                                <div class="form-group row mt-3">
                                    ...
                                    <div class="col-sm-10 col-md-10">
                                        <textarea name="other_description" id="other_description" class="form-control @error('other_description') is-invalid @enderror" placeholder="Enter Description" value="{{ old('other_description') }}">{{ old('other_description') }}</textarea>
                                ...
                                <div class="form-group row mt-3 p-3">
                                    <table class="table table-bordered p-3" id="dynamicAmenitiesTable">
                                        <thead>
                                            <tr>
                                                <th><b>Pillars Title : <span class="text-danger">*</span></b></th>
                                                <th><b>Pillars Description : <span class="text-danger">*</span></b></th>
                                                <th><b>Action</b></th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            @if(old('pillers_title'))
                                                @foreach(old('pillers_title') as $index => $value)
                                                    <tr>
                                                        <td>
                                                            <input type="text" name="pillers_title[]" value="{{ old("pillers_title.$index") }}" class="form-control @error("pillers_title.$index") is-invalid @enderror" placeholder="Enter Solution Name">
                                                        ...
                                                        <td>
                                                            <textarea name="pillers_description[]" class="form-control @error("pillers_description.$index") is-invalid @enderror" placeholder="Enter Solution Description">{{ old("pillers_description.$index") }}</textarea>
...
<script>
    $(document).ready(function () {
        let rowId = {{ old('pillers_title') ? count(old('pillers_title')) : 0 }};
