            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-body add-post">
                        <form method="POST" action="{{ route('contact-details.store') }}" class="form-horizontal" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="pd-20 card-box mb-30">
                                ...
                                <div class="form-group row mt-3">
                                    ...
                                    <div class="col-sm-4 col-md-4">
                                        <input type="text" name="company_mobile_no" id="company_mobile_no" class="form-control @error('company_mobile_no') is-invalid @enderror" value="{{ old('company_mobile_no') }}" placeholder="Enter Mobile Number">
                                    ...
                                    <div class="col-sm-4 col-md-4">
                                        <input type="email" name="company_email" id="company_email" class="form-control @error('company_email') is-invalid @enderror" value="{{ old('company_email') }}" placeholder="Enter Email Id">
                                        @error('company_email')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div class="form-group row mt-3">
                                    ...
                                    <div class="col-sm-4 col-md-4">
                                        <input type="text" name="location_map_iframe_link" id="location_map_iframe_link" class="form-control @error('location_map_iframe_link') is-invalid @enderror" value="{{ old('location_map_iframe_link') }}" placeholder="Enter Location Map Iframe Link">
                                ...
                                <div class="form-group row mt-3">
                                    ...
                                    <div class="col-sm-10 col-md-10">
                                        <textarea name="company_address" id="company_address" class="form-control @error('company_address') is-invalid @enderror" placeholder="Enter Company Address" value="{{ old('company_address') }}">{{ old('company_address') }}</textarea>
