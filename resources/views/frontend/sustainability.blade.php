...
@section('content')
    ...
    <div class="container">
        ...
        <div class="col-md-5">
            ...
            <img src="{{ asset('frontend/assets/images/sustainability/sustainability-img.jpg') }}" class="img-responsive">
            </div>
        </div>
        <div class="col-md-7">
            <div class="sustainability_content">
            <p>At Jett 4 Construction, we are committed to building a sustainable future. Our approach to construction integrates environmental responsibility, innovative design, and energy-efficient solutions, ensuring that every project we undertake aligns with global sustainability goals. </p>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-12 col-sm-12">
                    <div class="res-single-services">
                        <img src="{{ asset('frontend/assets/images/sustainability/regular-safety-meeting.jpg') }}" alt="Image" class="img-responsive">
                        <div class="services-content">
                            <h3>Regular Safety Meetings</h3>
                            <p>We conduct regular safety meetings to promote awareness and address on-site risks. These sessions cover
                                hazard identification, emergency preparedness, proper PPE usage, ergonomic practices, and more, ensuring
                                a well-informed and safety-conscious workforce.</p>
                            <span><img src="{{ asset('frontend/assets/images/icons/safety-meeting.png') }}" alt="Exterior Spray Treatments"></span>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-12 col-sm-12">
                    <div class="res-single-services">
                        <img src="{{ asset('frontend/assets/images/sustainability/safety-nets.jpg') }}" alt="Image" class="img-responsive">
                        <div class="services-content">
                            ...
                            <span><img src="{{ asset('frontend/assets/images/icons/safety-net.png') }}" alt="Exterior Spray Treatments"></span>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-12 col-sm-12">
                    <div class="res-single-services">
                        <img src="{{ asset('frontend/assets/images/sustainability/fire-drills.jpg') }}" alt="Image" class="img-responsive">
                        <div class="services-content">
                            <h3>Fire Drills</h3>
                            ...
                            <span><img src="{{ asset('frontend/assets/images/icons/fire-drills.png') }}" alt="Exterior Spray Treatments"></span>
                        </div>
                    </div>
                </div>
