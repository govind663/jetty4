        ...
        <div class="header-logo-wrapper col-auto p-0">
            <div class="logo-wrapper">
                <a href="{{ route('admin.dashboard') }}">
                    <img class="img-fluid for-light" src="{{ asset('frontend/assets/images/logo/Jett4-hori-logo-png.png') }}" alt="logo-light">
                    <img class="img-fluid for-dark" src="{{ asset('frontend/assets/images/logo/Jett4-hori-logo-png.png') }}" alt="logo-dark">
                </a>
            </div>
            ...
            <ul class="nav-menus">
                ...
                <li class="profile-nav onhover-dropdown">
                    <div class="media profile-media">
                        <img class="b-r-10" src="{{ asset('frontend/assets/images/logo/Jett4-hori-logo-png.png') }}" alt="" style="height: 50px; width: 100px;">
