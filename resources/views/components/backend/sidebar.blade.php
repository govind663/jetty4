        ...
        <div id="sidebar-menu">
            <ul class="sidebar-links" id="simple-bar">
                ...
                <li class="sidebar-list">
                    ...
                    <a class="sidebar-link sidebar-title {{ (Route::currentRouteName() === 'admin.dashboard') ? 'active' : '' }}" href="javascript:void(0)">
                    ...
                    <ul class="sidebar-submenu">
                        <li><a href="{{ route('admin.dashboard') }}" class="{{ (Route::currentRouteName() === 'admin.dashboard') ? 'active' : '' }}">Home</a></li>
                    </ul>
                </li>
