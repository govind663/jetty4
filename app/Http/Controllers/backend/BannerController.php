    ...
    public function store(BannerRequest $request)
    {
        ...
        try {
            ...
            if ($request->hasFile('banner_video')) {
                ...
                $new_name = time() . rand(10, 999) . '.' . $extension;
                $video->move(public_path('/j4c_Group/banner/banner_video'), $new_name);

                $video_path = "/j4c_Group/banner/banner_video/" . $new_name;
        ...
        try {
            ...
            if ($request->hasFile('banner_video')) {
                ...
                if ($banner->banner_video) {
                    $oldVideoPath = public_path('/j4c_Group/banner/banner_video/' . $banner->banner_video);
